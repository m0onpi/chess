...
const {videoPost, imagePost} = require('./redditmain');
...
const imagevideo = { path: './public/imagevideo.mp4', title: `${titles}` + ' ' + '#shorts' ,description: `${titles}` + ' ' + '#shorts' + ' ' + threetags,isAgeRestriction: false, isNotForKid: true}
const videovideo =  { path: './public/mainvideo.mp4', title: `${titles}` + ' ' + '#shorts' ,description: `${titles}` + ' ' + '#shorts' + ' ' + threetags,isAgeRestriction: false, isNotForKid: true}
